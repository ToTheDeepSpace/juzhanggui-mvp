  ...
  return (
    ...
    >
      <Section title="一、协议范围与服务定位">
        ...
        <p>玩家侧扫码、评价、拼车加入等功能用于完成具体店家排期流程和后续身份沉淀；部分玩家、DM、社区身份能力可能跳转或打通至剧幕录。</p>
      </Section>
      ...
      <Section title="五、第三方服务与线下履约">
        <p>剧司辰可能与剧幕录、腾讯云、Supabase、支付宝、微信、短信/邮件服务商、地图/二维码/对象存储等第三方能力配合，以完成登录、通知、支付、存储、跳转和运营功能。</p>
...
export function AiReadablePage() {
  return (
    <LegalLayout
      title="AI 可读说明"
      intro="本页用更结构化的方式说明剧司辰是什么、服务谁、和剧幕录是什么关系，方便搜索引擎、AI 助手和新接入的协作 Agent 快速理解。"
    >
      <Section title="一、剧司辰是什么">
        <p>剧司辰是面向剧本杀、沉浸式娱乐和演绎剧场店家的经营后台，核心功能包括排期、房间、剧本、卡司/DM、拼车上车、评价反馈、会员和公共剧本模板主库。</p>
        <p>剧司辰优先服务店家后台经营效率，不把自己定位成玩家社区首页。玩家身份、DM 公开身份、红黑白榜、委托需求和圈内口碑沉淀主要放在剧幕录。</p>
      </Section>
      <Section title="二、和剧幕录的关系">
        <p>剧司辰负责店家的排期和真实经营数据，剧幕录负责玩家、DM、灵契师、委托人、红黑白榜、拼车信息和口碑资产沉淀。</p>
        <p>两个产品共享同一个行业生态，但入口不同：店家先进剧司辰，玩家和社区用户先进剧幕录。</p>
      </Section>
